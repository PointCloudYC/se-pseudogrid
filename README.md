...
This repository is an official implementation of our new paper [Automated Classification of Piping Components from 3D LiDAR Point Clouds using SE-PseudoGrid](https://www.sciencedirect.com/science/article/pii/S092658052200173X), published in the [Automation in Construction](https://www.sciencedirect.com/journal/automation-in-construction) journal and its early short version will also appear in the [IPC2022 conference](https://www.cibwbc2022.org/about-3) in early July. (For free access, you may also read our AutoCon journal paper in the [ResearchGate](https://www.researchgate.net/publication/360393009_Automated_classification_of_piping_components_from_3D_LiDAR_point_clouds_using_SE-PseudoGrid).)
