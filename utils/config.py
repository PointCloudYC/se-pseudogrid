...
config.loss='smooth' # smooth, ce, wce, sqrt_ce
# ---------------------------------------------------------------------------- #
# Model
# ---------------------------------------------------------------------------- #
...
# for classification ,whether to use both global max and avg pooling, then concat to obtain 2C features
config.use_avg_max_pool=False
...
config.SE_squeeze_type = 'avg' # avg or max
config.SE_excitation_type = 'sigmoid' # sigmoid, relu, tanh
